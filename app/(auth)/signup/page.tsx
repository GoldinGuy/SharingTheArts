export const metadata = {
	title: "Sign Up - Sharing the Arts",
		...
		<>
			...
			<div className="max-w-3xl mx-auto text-center pb-12">
				...
				<h1 className="h2 font-cabinet-grotesk">
					You've been invited by Mark Hooker to join Sharing the Arts
				</h1>
			</div>
			{/* Form */}
			<div className="max-w-sm mx-auto">
				<form>
					...
					<div className="flex flex-wrap items-center justify-between mt-6">
						<Link
							className="font-medium text-sm sm:text-base text-yellow-500 decoration-yellow-500 decoration-2 underline-offset-2 hover:underline"
							href="/signin"
						>
							Go to Login
						</Link>
						<div className="ml-2">
							<button className="btn-sm text-white bg-yellow-500 hover:bg-yellow-600 shadow-sm">
								Join The Community
							</button>
						</div>
					</div>
					<div className="mt-5">
						<label className="flex items-start">
							...
							<span className="text-sm text-gray-500 ml-3">
								I accept the{" "}
								<a
									className="underline hover:decoration-yellow-500 underline-offset-2 hover:underline"
									href="#0"
								>
									terms
								</a>{" "}
