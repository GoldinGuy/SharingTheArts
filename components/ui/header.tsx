			...
			<div className="max-w-6xl px-4 mx-auto sm:px-6">
				<div className="flex items-center justify-between h-16 md:h-20">
					...
					<div className="mr-4 shrink-0">
						{/* Logo */}
						<Link className="block group" href="/" aria-label="">
							<svg
					...
					{nav && (
						<nav className="flex grow">
							...
							<ul className="flex flex-wrap items-center justify-end grow">
								<li>
									<Link
										className="flex items-center px-3 py-2 font-medium text-gray-600 transition duration-150 ease-in-out decoration-yellow-500 decoration-2 underline-offset-2 hover:underline lg:px-5"
								...
								<li className="ml-3">
									<Link
										className="w-full text-white bg-yellow-500 shadow-sm btn-sm hover:bg-yellow-600"
										href="/donate"
									>
										Support our Mission
									</Link>
