			...
			<div className="max-w-6xl mx-auto px-4 sm:px-6">
				<div className="py-12 md:py-20">
						...
						<div className="swiper-wrapper">
							...
							<div className="swiper-slide h-auto flex flex-col">
								...
								<div className="grow bg-white px-4 pb-6">
									...
									{/* Title */}
									<a
										className="inline-block font-cabinet-grotesk font-bold text-xl decoration-yellow-500 decoration-2 underline-offset-2 hover:underline"
										href="#0"
									>
										Digital Art
									</a>
					...
					<div className="flex mt-12 space-x-4 justify-end">
						<button className="carousel-prev relative z-20 w-14 h-14 rounded-full flex items-center justify-center group bg-gray-700 hover:bg-yellow-500 transition duration-150 ease-in-out">
						...
						<button className="carousel-next relative z-20 w-14 h-14 rounded-full flex items-center justify-center group bg-gray-700 hover:bg-yellow-500 transition duration-150 ease-in-out">
