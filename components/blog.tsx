							...
							<div className="grow flex flex-col">
								<header>
									<h3 className="h4 font-cabinet-grotesk font-bold mb-2">
										<a
											className="inline-block decoration-yellow-500 decoration-2 underline-offset-2 hover:underline"
											href="#0"
										>
								...
								<footer className="flex items-center text-sm mt-4">
									...
									<div>
										...
										<a
											className="font-medium decoration-yellow-500 decoration-2 underline-offset-2 hover:underline"
											href="#0"
										>
											Knut Mayer
										</a>
