				...
				<div className="py-8">
					...
					<div className="relative px-8 py-12 md:py-20 md:px-12">
						...
						<div className="flex flex-col items-center justify-between lg:flex-row">
							{/* CTA content */}
							<div className="relative mb-6 text-center lg:mr-16 lg:mb-0 lg:text-left">
								<svg
									className="absolute left-0 mb-4 bottom-full"
									width="82"
									height="75"
								...
								<h3 className="text-gray-100 h2 font-cabinet-grotesk">
									Help us share the arts with students in Palm Beach County
								</h3>
							</div>
							{/* CTA button */}
