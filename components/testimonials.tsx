						...
						<div className="relative px-6 pb-8 md:px-12 lg:pb-0">
							...
							<div className="testimonial-carousel swiper-container">
								<div className="swiper-wrapper">
									{/* Testimonial */}
									<div className="items-center space-y-8 text-center swiper-slide lg:flex lg:space-y-0 lg:space-x-8 lg:text-left">
										<div className="relative inline-flex shrink-0">
											...
											{/* <div className="absolute bottom-0 right-0 mb-6 mr-4">
												<a
													className="flex items-center px-3 py-1 font-bold bg-white rounded-full shadow-sm font-cabinet-grotesk decoration-yellow-500 decoration-2 underline-offset-2 hover:underline"
													href="#0"
												>
													<svg
										...
										<div className="relative">
											...
											<div>
												<a
													className="text-white bg-yellow-500 shadow-sm btn-sm hover:bg-yellow-600 group"
													href="#0"
												>
													Read Story{" "}
													<span className="tracking-normal text-yellow-200 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">
														-&gt;
													</span>
												</a>
											</div>
							...
							{/* Bullets */}
							<div className="bottom-0 right-0 z-10 mt-4 lg:absolute lg:mt-0 lg:mr-12 lg:mb-16">
								<div className="text-center testimonial-carousel-pagination" />
							</div>
						</div>
					</div>
				</div>
